			...
			public CReturn call(Object object) { 			
				try {
					...
					switch(ioptype) {
						case CThread.START: 
							//__.alert("starting");
							//__.alert(cthread._int("m_iintervalms"));
							if(cthread._cfunction("m_fnrun") != null)
								cthread._("m_iintervalid", __.setInterval(cthread._cfunction("m_fnrun"), cthread._int("m_iintervalms")));		
						break;
						...
						case CThread.STOP: 
							__.clearInterval(cthread._int("m_iintervalid")); 
