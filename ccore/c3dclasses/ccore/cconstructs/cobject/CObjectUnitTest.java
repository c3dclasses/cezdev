...
public class CObjectUnitTest extends CUnitTest {
	@Test
	public void test() {
		CObject cobject = new CObject(); // __.cobject()
		cobject._("my_prop1", "this is my property");
		cobject._("my_prop2", 10);
		cobject._("my_prop3", 10.8);
		cobject._("my_prop4", __.carray(10,10,10));
		cobject._("my_prop5", __.chash("prop1",10,"prop2",10));
		cobject._("my_prop6", __.chash(
					"prop1", __.chash(
						"inner-name", 10
						), // end chash
					"prop2", __.carray(10,20,30)
				) // end chash
		); // end cobject
