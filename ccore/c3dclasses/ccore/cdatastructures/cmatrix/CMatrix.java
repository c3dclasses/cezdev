...
public class CMatrix extends CArray {	
	...
	public CMatrix subMatrix(int srow, int erow, int scol, int ecol) {
		...
		for(int i=srow; i<erow+1; i++)
			M.push(this.i(i).subCVector(scol, ecol));		
		return M;
	} // end subMatrix()
	...
	public boolean toImageFile(String strimgfilename, String strformat) { return __.save_img_file(strimgfilename, strformat, this); }
