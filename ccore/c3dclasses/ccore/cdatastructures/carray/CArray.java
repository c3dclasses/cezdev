...
public class CArray extends CCast {
	...
	public boolean empty() { return this.m_array.size() == 0; }
	
	/////////////////////////
	// equality
	//public int compare(int i, int j, CFunction cmpfunc) { return cmpfunc.call(__.args(this._(i), this._(j)))._int(0); } 
	...
	public Object middle() { return this.get(this.length()/2); }
	...
	public boolean exist(int index) { return this.get(index) != null; }
	
	////////////////////
	// operations
	public int push(Object element) { this.m_array.add(element); return this.length(); } 
	public int enqueue(Object element) { this.m_array.add(element); return this.length(); } 
    ...
    public String join(String seperator) { 
		...
		String str = ""; 
		for(int i=0; i<len; i++) {
			String value = (m_array.get(i) == null) ? "" : m_array.get(i).toString(); 
			str += value + ((i!=len-1) ? ""+seperator : ""); 
		}
		return str; 
	} // end join()
	...
	public Object deque() { return shift(); }
	...
	public void dec_sort() { Collections.sort(this.m_array, Collections.reverseOrder(Collections.reverseOrder())); }
	public void sort(Comparator cmp) { Collections.sort(this.m_array, cmp); }
	public void sort(CFunction cmp) { CFunctionToJavaComparator jcmp = new CFunctionToJavaComparator(cmp); this.sort(jcmp); }
	...
	*/
	...
	public CArray powerset(int itemsize) {
		...
		CArray powerset = __.carray();
		for(int i=0; i<n; i++) {
			CArray set = __.carray();
	...
	public void foreach(CFunction cfunction) { this.visit(cfunction, null); }
    ...
    public void visit(CFunction cfunction, Object obj) { 
		...
		for(Object element : this.m_array) { 
			cfunction.call(__.carray(i, element, obj));
			// new Object []  { i, element, obj }); 
			i++; 
		} // end for
		return; 
	} // end visit()
	...
	*/
	int partition(int low, int high, CFunction fncompare) {   	
		...
		for (int j = low; j <= high-1; j++) {
			if (fncompare.call(__.args(pivot, this._(j)))._boolean()) {
				i++;   
				this.swap(i,j);
			} // end if
		} // end for 
	...
	//////////////////////////
	// toString, toJSON()
	public String toString() { return __.print_r(this.m_array, true); }
	public String toJSON(boolean bpack) { return CJSON.encode(this, bpack); }
	public String toJSON() { return this.toJSON(false); }
	public void toJSONFile(String strfilename) { CJSON.toFile(this, true, strfilename); }
...
//---------------------------------------------------------
// name: CFunctionToJavaComparator
// desc: converts a cfunction to a java comparator object
//---------------------------------------------------------
class CFunctionToJavaComparator implements Comparator<Object> { 
	protected CFunction m_cmpfunc;
    public CFunctionToJavaComparator(CFunction cmpfunc) { this.m_cmpfunc = cmpfunc; }
	public int compare(Object a, Object b) { return this.m_cmpfunc.call(__.args(a,b))._int(); } 
} // end CArrayComparator