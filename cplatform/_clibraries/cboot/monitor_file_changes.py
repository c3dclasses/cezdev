"""
name: monitor_file_changes.py
desc: Monitors multiple directories for file changes using watchdog library.
usage:
    python monitor_file_changes.py <directories> [callback-scripts] [exclude-patterns]
    
    All arguments support comma-separated values for multiple entries.
    
examples:
    # Single directory
    python monitor_file_changes.py "C:\myproject"
    
    # Multiple directories
    python monitor_file_changes.py "C:\project1,C:\project2,C:\project3"
    
    # Single directory with single callback
    python monitor_file_changes.py "C:\myproject" "callback.bat"
    
    # Multiple directories with multiple callbacks
    python monitor_file_changes.py "C:\proj1,C:\proj2" "handler1.bat,handler2.bat"
    
    # With exclude patterns (regex, already supports | for OR)
    python monitor_file_changes.py "C:\myproject" "callback.bat" "\.git|\.pyc|__pycache__"
    
    # Multiple exclude patterns (comma-separated, combined with |)
    python monitor_file_changes.py "C:\myproject" "" "\.git,\.pyc,__pycache__,node_modules"
"""
...
class FileChangeHandler(FileSystemEventHandler):
    ...
    def on_modified(self, event):
        ...
        try:
            ...
            # File may have been deleted, let it pass through
            pass
...
def main():
    if len(sys.argv) < 2:
        ...
        print()
        print("Usage:")
        print("    python monitor_file_changes.py <directories> [callback-scripts] [exclude-patterns]")
        print()
        print("    All arguments support comma-separated values for multiple entries.")
        print()
        print("Examples:")
        print("    python monitor_file_changes.py \"C:\\myproject\"")
        print("    python monitor_file_changes.py \"C:\\proj1,C:\\proj2\"")
        print("    python monitor_file_changes.py \"C:\\myproject\" \"callback.bat\"")
        print("    python monitor_file_changes.py \"C:\\proj1,C:\\proj2\" \"handler1.bat,handler2.bat\"")
        print("    python monitor_file_changes.py \"C:\\myproject\" \"\" \"\\.git,\\.pyc,__pycache__\"")
        print()
        sys.exit(1)
