...
class CFooInstructions extends CInstructions {	
	public CFooInstructions(CProcessor cprocessor) {
		super(cprocessor);
		CFunction fnAdd = new CFunction() { public CObject _(CObject cobject) { 
			int iop1 = cobject._int("m_iop1");
			int iop2 = cobject._int("m_iop2");
			cobject._("m_result", iop1 + iop2);		
			return cobject;
		}}; // end fnAdd()
		CFunction fnMulitply = new CFunction() { public CObject _(CObject cobject) { 
			int iop1 = cobject._int("m_iop1");
			int iop2 = cobject._int("m_iop2");
			cobject._("m_result", iop1 * iop2);		
			return cobject;
...
class CFooObject extends CObject {
	...
	public CFooObject setProp(String strop, int op1, int op2) {	
		...
		this._("m_iop1", op1);
		this._("m_iop2", op2);
		CFooObject.m_cfooprocessor.process(this);
		return this;
	} // end setProp()
} // end CFooObject
