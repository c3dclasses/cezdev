...
public class CFunctionUnitTest extends CUnitTest{
	...
	public void test() {
		...
		this.assertTrue(cfunction1._(_.args(4, 4))._int(0) == 16);	
		...
		final CFunction cfunction2 = new CFunction() { 
			public CArray _(CHash params) { 
				int value1 = params._int("prop1");
				int value2 = params._int("prop2");
				return _.args(value1, value2); 
			} // end _()		
		}; // end CFunction()

		// call and print the values of the function
		CArray args = cfunction2._(_.params("prop1", 8, "prop2", 20));
		this.assertTrue(args._int(0) == 8);	
		this.assertTrue(args._int(1) == 20);	
		...
		// call and print the value of the function
		this.assertTrue(cfunction3._(_.args())._string(0) == "meta-value1");	
	} // end main()
} // end CFunctionMain