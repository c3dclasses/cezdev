...
public class _ {	
	...
	public static String check_file_path(String strpath) { String path = _.file_path(strpath); return (strpath == "" || strpath == null || path == "" || path == null) ? strpath : _.file_path(strpath); }
	...
	public static String check_dir_path(String strpath) { String path = _.file_path(strpath); return (strpath == "" || strpath == null || _.file_path(strpath) == "" || path == "" || path == null) ? strpath : _.file_path(strpath); }
    ...
    public static boolean resize_img_file(String inputImagePath, String outputImagePath, double percent){
        try {
			...
			return _.resize_img_file(inputImagePath, outputImagePath, scaledWidth, scaledHeight);
		} // end try
		catch(Exception ex) {
			return false;
		}
	...
	*/
	...
	///////////////
	// carray
	public static CArray carray_csv(String strfilename) { return _.load_csv_file(strfilename); }
	public static CArray carray_c(int... capacity) { return new CArray(capacity); }
	//public static CArray json_2_carray(String strjsonfile) { return CJSON.toCHash(strjsonfile); }
	...
	public static CHash json_file_2_chash(String strjsonfile) { return CJSON.toCHash(_.file_get_contents(strjsonfile)); }
	...
	//public static CCommand cmd(String strname) { return _.ccommand(strname); }
	//public static CCommand c(String strname) { return _.ccommand(strname); }
	...
	public static CMatrix cmatrix_csv(String strcsvfilename) { return _.cmatrix(_.load_csv_file(strcsvfilename)); }
