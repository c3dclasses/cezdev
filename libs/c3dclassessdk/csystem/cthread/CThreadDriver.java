			...
			public CReturn call(Object object) { 
				try {
					...
					switch(ioptype) {
						...
						case CThread.JOIN: cjavathread.join(cthread._long("m_inparam")); break;
...
class CJavaThread extends Thread {	
	...
	public void run() { _.println("running CJavaThread"); this.m_cthread._cfunction("m_fncallback").call((Object)this.m_cthread); }
} // end CJavaThread